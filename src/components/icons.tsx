...
export function IconLeaf({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 22c-4-4-8-8-8-14a8 8 0 0116 0c0 6-4 10-8 14z" strokeLinecap="round" strokeLinejoin="round" />
...
export function IconDroplet({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 2.69l5.66 5.66a8 8 0 11-11.32 0L12 2.69z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconMicroscope({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <circle cx="12" cy="12" r="3" />
      <path d="M12 15v6M9 21h6M6 6l3 3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function IconSprout({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M7 20h10M12 20V10M8 10c0-4 4-6 4-6s4 2 4 6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
